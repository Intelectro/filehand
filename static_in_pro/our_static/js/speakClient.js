//var generatorurl = "{% static 'js/speakGenerator.js' %}";
//var workerurl = "{% static 'js/speakWorker.js' %}";
var speakWorker;
try {
  //speakWorker = new Worker('C:\__files\DJANGO\DJANGO_TRAIN_01\src\static_in_pro\our_static\js\speakWorker.js');
  //speakWorker = new Worker("{% static 'js/speakWorker.js' %}");
  //window.alert('1 HERE HERE ' + workerurl);
  speakWorker = new Worker(workerurl);
} catch(e) {
  console.log('speak.js warning: no worker support');
}

//window.alert(' 2 HERE HERE ' + workerurl);
